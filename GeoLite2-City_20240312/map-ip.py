...
def get_geolocation(ip_address):
    try:
        ...
        google_maps_url = f"https://www.google.com/maps/search/?api=1&query={response.location.latitude},{response.location.longitude}"

        # Open the location in Google Maps
        print(f"Opening location in Google Maps...")
